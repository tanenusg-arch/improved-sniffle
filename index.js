// ===================================================================
// MERGED INDEX.JS – Webhook version (Full Code)
// ===================================================================
...
// Render sets RENDER_EXTERNAL_URL automatically; otherwise provide your own.
const PUBLIC_URL = process.env.RENDER_EXTERNAL_URL || process.env.PUBLIC_URL || "https://improved-sniffle6.onrender.com";
...
// ===================================================================
// 8. MAIN APPLICATION – with smart editing, photo deletion, and webhooks
// ===================================================================
...
// Helper: send or edit a text message
...
// Helper: send or replace a photo
...
async function main() {
  ...
  bot.on('callback_query', async (ctx) => {
    ...
    if (data === "profile_referral") {
      ...
      const kb = {
        inline_keyboard: [[{ text: "Back to Profile", callback_data: "menu_profile", icon_custom_emoji_id: ID_BACK }]]
      };
  ...
  // Webhook endpoint
  app.use(WEBHOOK_PATH, await bot.webhookCallback(WEBHOOK_PATH));
